...
const QuadcopterPhysics_1 = require("./lib/physics/QuadcopterPhysics");
...
const initialState = {
    ...
    quaternion: pythonData.steps[0].state_before.quaternion,
    angularVelocity: pythonData.steps[0].state_before.angular_velocity,
};
const physics = new QuadcopterPhysics_1.QuadcopterPhysics(initialState, {
    mass: simParams.mass,
...
for (let stepIdx = 0; stepIdx < stepsToTest; stepIdx++) {
    ...
    if (!compareVectors([...currentState.position, ...currentState.velocity, ...currentState.quaternion, ...currentState.angularVelocity], pythonStep.normalized_state, 1e-10, 'Initial state')) {
