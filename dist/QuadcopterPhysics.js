...
export class QuadcopterPhysics {
    ...
    step(action, dt) {
        ...
        const acceleration = [initialDerivatives[3], initialDerivatives[4], initialDerivatives[5]];
        const angularAcceleration = [initialDerivatives[10], initialDerivatives[11], initialDerivatives[12]];
